...
get_response = WS.sendRequest(findTestObject('causes/GetSpecificCause', [('x_customer') : GlobalVariable.x_customer_id, ('x_coverage') : GlobalVariable.x_coverage
            , ('x_contributor') : GlobalVariable.x_contributors, ('authorization') : GlobalVariable.authorization, ('cause_id') : cause_id]))
